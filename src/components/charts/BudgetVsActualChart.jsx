      ...
      <div className="mt-2" style={{ height: 260 }}>
        <ResponsiveContainer width="100%" height="100%">
          <BarChart data={data} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
            ...
            />
            <Bar dataKey="budget" name="Budget Limit" fill={THEME.accent} opacity={0.4} radius={[4, 4, 0, 0]} />
            <Bar dataKey="spent" name="Actual Spent" fill={THEME.accent2} radius={[4, 4, 0, 0]} />
          </BarChart>
        </ResponsiveContainer>
      </div>
    </Card>
